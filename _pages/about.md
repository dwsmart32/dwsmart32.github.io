...
<style>
    .education-entry {
        ...
        align-items: center;
        margin-bottom: 20px; /* 항목별 줄 간격 */
    }
    .time-period {
        font-size: 0.8em;  /* 글자 크기를 현재의 80%로 설정 */
        white-space: nowrap;
    }
    .school-name, .degree, .time-period, .military-service {
        margin: 0;
    }

    .school-name, .military-service {
        font-size: 100%;
...
<style>
    ...
    .company-name, .role, .description, .time-period, .location, .github-link {
        margin: 0;
    }

    .company-name, .location {
        font-size: 0.95em; /* 글씨체 크기 수정 */
    }

    .role {
        font-size: 0.9em; /* 글씨체 크기 수정 */
    }

    .description, .github-link {
        font-size: 0.8em; /* 글씨체 크기 수정 */
        margin-left: 20px; /* 들여쓰기 */
    }

  .time-period {
      font-size: 0.8em;  /* 이 값을 조정하여 글자 크기를 변경하세요. */
      margin-left: auto;
      white-space: nowrap;
  }
</style>
...
<div class="experience-section">
  ...
  <div class="experience-entry">
    <div>
      <div class="company-line"><span class="company-name">Hyundai Mobis</span> <span class="location">| Mabuk, Korea</span></div>
      <p class="role">Electric Car Motor Design Team Intern</p>
      <p class="description">Optimized the motor balance to address the unbalanced mass in the electric vehicle's drive rotor using MatLab and CATIA, based on an in-depth knowledge of mechanics.</p>
    </div>
    <p class="time-period">Feb.2021 - Mar.2021</p>
  </div> -->
  ...
  <div class="experience-entry">
    <div>
      ...
      <p class="github-link"><a href="https://github.com/SSAI-Remote-Proctor">Github Organization</a></p>
    </div>
